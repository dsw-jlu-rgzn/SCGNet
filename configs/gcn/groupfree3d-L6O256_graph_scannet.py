...
# lr_config = dict(policy='step', warmup=None, step=[56, 68, 80])

load_from = 'configs/groupfree3d/groupfree3d_8x4_scannet-3d-18class-L6-O256_20210702_145347-3499eb55.pth'
